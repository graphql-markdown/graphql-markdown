...
Defined in: [events/render-root-types.ts:15](https://github.com/graphql-markdown/graphql-markdown/blob/main/packages/core/src/events/render-root-types.ts#L15)
...
```ts
new RenderRootTypesEvent(data): RenderRootTypesEvent;
```

Defined in: [events/render-root-types.ts:19](https://github.com/graphql-markdown/graphql-markdown/blob/main/packages/core/src/events/render-root-types.ts#L19)
...
Defined in: [events/render-root-types.ts:17](https://github.com/graphql-markdown/graphql-markdown/blob/main/packages/core/src/events/render-root-types.ts#L17)
