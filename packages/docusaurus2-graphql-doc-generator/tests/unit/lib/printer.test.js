    ...
    describe("class Printer", () => {
      ...
      describe("printSectionItem()", () => {
        ...
        test("returns Markdown #### link section with sub type", () => {
          ...
          jest.spyOn(graphql, "getTypeName").mockImplementation((type) => {
            return type.name;
          });
          jest.spyOn(graphql, "getNamedType").mockImplementation((type) => {
            return type.name;
          });
          jest
      ...
      describe("printCodeArguments()", () => {
        test("returns a Markdown one line per formatted argument with default value surrounded by ()", () => {
          ...
          jest.spyOn(graphql, "getDefaultValue").mockImplementation((type) => {
          ...
          (type) => {
            ...
            jest
              ...
              .mockImplementation((type) => {
                return `Test ${capitalize(type.name)}`;
              });
            jest
