...
Force generating documentation in an empty folder and override `diffMethod` value to `FORCE`. If the folder located at `rootPath/baseURL` is not empty, then the plugin will delete it and recreate
