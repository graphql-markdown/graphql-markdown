...
const pluginConfigFilename1 =
  "docusaurus2-graphql-doc-generator-multi-instance-1.config.js";
const pluginConfigFilename2 =
  "docusaurus2-graphql-doc-generator-multi-instance-2.config.js";
...
module.exports = ${JSON.stringify(config)};\n`
  .replace(
    `"@config1@"`,
    `require(path.resolve(__dirname, "${pluginConfigFilename1}"))`,
  )
  .replace(
    `"@config2@"`,
    `require(path.resolve(__dirname, "${pluginConfigFilename2}"))`,
  );
...
const basicSchema = require(path.resolve(__dirname, "${pluginConfigFilename1}"));
